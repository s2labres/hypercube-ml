...
class TemporalLuckEvaluatorTests(unittest.TestCase):
    ...
    def test_train_all_classifiers(self):
        ...
        with (mock.patch.object(self.temporal_luck_evaluator, "train_classifier") as train_classifier_mock,
              mock.patch("temporal_luck.temporal_luck_evaluator.os.makedirs") as make_dirs_mock):
        ...
        train_classifier_mock.assert_has_calls(expected_train_classifier_calls, any_order=True)
    ...
    def test_train_classifier(self):
        ...
        with (mock.patch("temporal_luck.temporal_luck_evaluator.get_labels_from_meta", side_effect=fake_labels),
              mock.patch("temporal_luck.temporal_luck_evaluator.get_shas_in_time_frame", side_effect=fake_shas),
              mock.patch("temporal_luck.temporal_luck_evaluator.os.makedirs") as make_dirs_mock,
              mock.patch("temporal_luck.temporal_luck_evaluator.os.listdir",
                         side_effect=[[], [], [1]]) as make_dirs_mock,
              mock.patch("temporal_luck.temporal_luck_evaluator.LoggerManager.get_logger", return_value=FakeLogger()),
